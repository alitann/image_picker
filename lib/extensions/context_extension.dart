...
extension MediaQueryExtension on BuildContext {
  ...
  double get lowValue => mediaQuery.orientation == Orientation.portrait ? height * 0.01 : width * 0.01;

  double get mediumLowValue => mediaQuery.orientation == Orientation.portrait ? height * 0.015 : width * 0.015;

  double get mediumValue => mediaQuery.orientation == Orientation.portrait ? height * 0.04 : width * 0.04;

  double get mediumMHighValue => mediaQuery.orientation == Orientation.portrait ? height * 0.06 : width * 0.06;

  double get mediumHighValue => mediaQuery.orientation == Orientation.portrait ? height * 0.08 : width * 0.08;

  double get highValue => mediaQuery.orientation == Orientation.portrait ? height * 0.1 : width * 0.1;
}
...
extension PaddingSymetricExtension on BuildContext {
  ...
  EdgeInsets get paddingMediumLowHorizontal => EdgeInsets.symmetric(horizontal: mediumLowValue);
